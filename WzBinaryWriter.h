			...
			*/
			...
			public:
				...
				bool LeaveOpen{};
					...
					#region Constructors
						public WzBinaryWriter(Stream output, std::vector<uint8_t>& WzIv) : this(output, WzIv, false) { }

				public WzBinaryWriter(Stream output, std::vector<uint8_t>& WzIv, bool leaveOpen) : base(output) {
