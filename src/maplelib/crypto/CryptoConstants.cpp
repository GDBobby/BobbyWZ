...
namespace MapleLib {
	namespace CryptoLib {
		const std::array<uint8_t, 128> CryptoConstants::UserKey = { //16 * 8
		...
		const std::array<uint8_t, 256> CryptoConstants::bShuffle = {//16 * 16
		...
		const uint8_t CryptoConstants::bDefaultAESKeyValue[] = {
				0xC6, 0x50, 0x53, 0xF2, 0xA8, 0x42, 0x9D, 0x7F, 0x77, 0x09, 0x1D, 0x26, 0x42, 0x53, 0x88, 0x7C,
		};
		std::vector<uint8_t> CryptoConstants::getTrimmedUserKey() {
