...
namespace MapleLib {
	namespace CryptoLib{
		...
		public:
			...
			/// </summary>
			constexpr static uint8_t UserKey[] = { //16 * 8
			...
			/// </summary>
			constexpr static uint8_t bShuffle[] = {//16 * 16
			...
			/// </summary>
			constexpr static uint8_t bDefaultAESKeyValue[] = {
			...
			/// </summary>
			constexpr static uint8_t WZ_GMSIV[] = { 0x4D, 0x23, 0xC7, 0x2B };

			/// <summary>
			/// IV used to create the WzKey for MSEA
			/// </summary>
			constexpr static uint8_t WZ_MSEAIV[] = { 0xB9, 0x7D, 0x63, 0xE9 };
